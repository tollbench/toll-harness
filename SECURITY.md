...
filesystem access, and raw secret access from its standard capability set. Providers must
scope credentials to the minimum resources required by each agent.
